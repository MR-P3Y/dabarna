Warning: truncated output (original token count: 50618)
Total output lines: 5475
    ...
    *,
    ...
    for item in refunds:
        ...
        text = (
            ...
            f"📝 علت کنسل: <b>{reason_ht…30618 tokens truncated…         f'<a href="{safe_url}">مشاهده پخش زنده بازی #{int(game_id)}</a>\n\n'
